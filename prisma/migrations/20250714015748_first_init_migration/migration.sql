...
-- AddForeignKey
ALTER TABLE "UserRole" ADD CONSTRAINT "UserRole_department_id_fkey" FOREIGN KEY ("department_id") REFERENCES "Department"("id") ON DELETE SET NULL ON UPDATE CASCADE;
